        ...
        <div className="contentDiv mx-auto flex px-18 pt-36 pb-36 md:flex-row flex-col items-center">
          ...
          >
            ...
            <p className="text-gray-700 text-lg mb-5 mt-1 leading-relaxed">
              <span className="font-semibold">Saylani Microfinance App</span> is
              a platform designed to provide installment-based loans to the
            ...
            <div className="flex lg:justify-center justify-start gap-3">
              <Link to={"/user"}>
                <button className="inline-flex cursor-pointer text-lg font-semibold bg-blue-600 hover:bg-blue-500 text-white px-8 py-2 rounded-md">
                  Apply For Loan
                </button>
              </Link>
            </div>
