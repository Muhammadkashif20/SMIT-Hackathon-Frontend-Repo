...
function BusinessLoans() {
  ...
  const subCategoriesOptions = {
    Structure: ["Hall Decoration", "Catering", "Photography"],
    Finishing: ["Sofa Set", "Bed Set", "Dining Table"],
    BusinessLoan: ["Small Business", "Startup Funding", "Equipment Financing"]
  };
  ...
  return (
    <Sidebar>
      <div className="flex justify-between mb-6">
        <h1 className="text-center text-blue-600 text-2xl font-bold">Business Loans</h1>
