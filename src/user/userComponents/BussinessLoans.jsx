    ...
    return(
        <>
         ...
         <div className="flex justify-between">
               <h1 className="text-center text-blue-600 text-2xl font-bold">Bussiness Loan</h1>
            ...
            <Modal title="Bussiness Loan" onCancel={handleCancel} open={isModalOpen} onOk={handleOk}>
              <div className="flex gap-3 pt-5 justify-between">
               ...
               <div className="pt-5">
                  <select className="border border-gray-300 rounded-md p-2 focus:outline-none w-full">
                     ...
                     <option>Buy Stall</option>
                     <option>Advance Rent for Shop</option>
                     <option> Shop Assets</option>
                     <option> Shop Machinery</option>
                  </select>
               </div>
