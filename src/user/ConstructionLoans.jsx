...
function ConstructionLoans() {
  ...
  const subCategoriesOptions = {
    LandPurchase: ["Residential Plot", "Commercial Plot", "Agricultural Land"],
    MaterialCosts: ["Cement & Bricks", "Iron & Steel", "Woodwork & Flooring"],
    HomeExpansion: ["Additional Rooms", "Floor Extension", "Garden & Landscape"],
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          <div className="w-full">
            ...
            >
              ...
              <option value="HomeExpansion">Home Expansion</option>
              <option value="MaterialCosts">Material Costs</option>
              <option value="LandPurchase">Land & Purchase</option>
            </select>
          </div>
        </div>
